...
The moat. Stella/Aya personalize content; we personalize the *relationship*. Memory compounds: the longer you stay, the better it gets, the harder it is to leave.
...
## Product decisions
- Memory v1 is deliberately simple: structured profile + tagged memory items + phrase list. No embeddings/RAG sophistication needed to feel magical at V1 — the *product behaviors* above matter more than retrieval tech. (Guard against over-engineering; tech design comes later.)
