...
Grounded in the research palette (lavender = blue's calm + pink's warmth) and the competitor world (pink→lavender→purple gradients) but *more restrained* — Aya's editorial calm over Stella's glassy density.
...
- **Cards:** rounded 20–24 radius; two kinds — *solid warm* (Sand/​surface, default) and *glassy translucent* (hero: Today's Moment, player) with subtle border + faint shadow.
