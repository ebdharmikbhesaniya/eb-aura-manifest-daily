...
2. **Confidentiality promise kept literally:** "Nothing you share leaves this room" = user content is used only to generate *their* content. Free-text (struggles, gratitude, self-description) never enters analytics, marketing, or model-training pipelines beyond serving that user. LLM/TTS vendors must be under no-training/no-retention terms (verify in technical planning).
