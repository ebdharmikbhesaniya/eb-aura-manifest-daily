...
*Supabase Auth, anonymous-first. Resolves product doc 20 Open Question #8. Implements the friction rule from product doc 07: no email asked at onboarding.*
...
Mechanism — Supabase identity linking on the *same* user (no data migration ever needed):
