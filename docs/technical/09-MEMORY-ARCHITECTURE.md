...
*The moat. Implements product doc 10 (Living Memory) and the callback cadence from 16. Deliberately simple by design decision (product 10): structured rows + phrase list, **no embeddings/RAG at V1** — the behaviors matter, not retrieval tech. Schema → 02 §2.*
