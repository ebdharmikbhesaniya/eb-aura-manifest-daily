...
*Implements the product defined in `/docs/PROJECT-KNOWLEDGE.md` and `/docs/00–20`. This document is the system map; every numbered technical doc drills into one area.*
